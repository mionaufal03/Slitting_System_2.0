...
<div class="container">
    ...
    <table class="table table-bordered table-striped align-middle text-center">
        ...
        <tbody>
<?php if ($coilsResult && $coilsResult->num_rows > 0): ?>
    <?php while ($row = $coilsResult->fetch_assoc()): ?>
        <tr>
            <td><?= (int)$row['id'] ?></td>
            ...
            <?php if ($_SESSION['role'] === 'mkl3'): ?>
                ...
                <a href="delete_mother.php?id=<?= (int)$row['id'] ?>" 
                   class="btn btn-danger btn-sm"
                   onclick="return confirm('Are you sure?')">
                   Delete
                </a>
                
                <a href="print_mother.php?id=<?= (int)$row['id'] ?>" class="btn btn-info btn-sm" target="_blank">Print</a>
            <?php else: ?>
