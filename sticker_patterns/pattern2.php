<?php
// Pattern 2 - NAX, TAIHO, ASHUKA, NTC
    ...
    <div class="sticker-container">
        ...
        <div class="content-left">
            ...
            <div class="row">
                ...
                <div class="colon">:</div>
                <div class="value" style="font-size: 11pt; font-weight: normal; text-overflow: ellipsis;"><?= htmlspecialchars(getCustomerFullName($customer)) ?></div>
            </div>
